...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("DRIVER", "ADMIN", "SUPERADMIN", name="userrole"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column(
            "type", sa.Enum("CAR", "BIKE", "TRUCK", name="vehicletype"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "alert_type",
            sa.Enum("OVERSPEED", "GEOFENCE", "OVERHEATING", name="alerttype"),
            nullable=True,
        ),
